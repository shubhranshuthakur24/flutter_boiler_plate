import 'package:flutter_boiler_plate/app/helpers/api_related_services/apis_endpoint.dart';
...
import '../../../components/message_widget/global_message_widget.dart';
import '../../../components/side_menu/views/widgets/side_bar_panel.dart';
import '../../../styles/constants.dart';
import '../../chat_with_claude_model/models/chat_with_claude_message_model.dart';
import '../services/chat_search_with_pdf_openai_model_screen_services.dart';

class ChatSearchWithPdfOpenAIModelScreen extends GetView<ChatSearchWithPdfOpenAIModelScreenServices> {
  const ChatSearchWithPdfOpenAIModelScreen({super.key});
      ...
      body: SideBarPanel(
        ...
        child: Column(
          children: [
            ...
            CustomChatInput(
              textController: controller.openAIPdfTextController,
              onMessageSubmit: (text) {
                controller.handleEnterKey(isApiLoading: controller.isSimpleChatApiLoading, messageInput: controller.openAIPdfTextController.text, inputTextEditingController: controller.openAIPdfTextController, isFeedbackFormVisible: controller.showFeedbackResponseForm, apiUrlFromScreen: ApiEndpoints.searchWithPdfOpenaiModel);
              },
              onSendTap: () {
                String message = controller.openAIPdfTextController.text;
                if(!controller.isSimpleChatApiLoading.value) {
                  controller.apiGetChatData(sentMessages: message,
                      ...
                      inputTextEditingController: controller.openAIPdfTextController, isFeedbackFormVisible: controller.showFeedbackResponseForm, apiUrlFromScreen: ApiEndpoints.searchWithPdfOpenaiModel);
                }
