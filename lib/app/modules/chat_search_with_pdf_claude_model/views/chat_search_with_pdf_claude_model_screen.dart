...
import '../../chat_with_claude_model/services/chat_with_claude_model_screen_services.dart';
import '../services/chat_search_with_pdf_claude_model_screen_services.dart';

class ChatSearchWithPdfClaudeModelScreen extends GetView<ChatSearchWithPdfClaudeModelScreenServices> {
  const ChatSearchWithPdfClaudeModelScreen({super.key});
  @override
      ...
      body: SideBarPanel(
        ...
        child: Column(
          children: [
            ...
            CustomChatInput(
              textController: controller.claudePDFChatTextController,
              onMessageSubmit: (text) {
                controller.handleEnterKey(isApiLoading: controller.isSimpleChatApiLoading, messageInput: controller.claudePDFChatTextController.text, inputTextEditingController: controller.claudePDFChatTextController, isFeedbackFormVisible: controller.showFeedbackResponseForm, apiUrlFromScreen: ApiEndpoints.searchWithPdfClaudeModel);
              },
              onSendTap: () {
                if(!controller.isSimpleChatApiLoading.value) {
                  controller.apiGetChatData(sentMessages:  controller.claudePDFChatTextController.text,
                      isApiLoading: controller.isSimpleChatApiLoading,
                      inputTextEditingController: controller.claudePDFChatTextController, isFeedbackFormVisible: controller.showFeedbackResponseForm, apiUrlFromScreen: ApiEndpoints.searchWithPdfClaudeModel);
                }
