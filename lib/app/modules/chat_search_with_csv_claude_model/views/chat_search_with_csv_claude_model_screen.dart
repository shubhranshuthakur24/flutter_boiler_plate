...
import '../services/chat_search_with_csv_claude_model_screen_services.dart';

class ChatSearchWithCsvClaudeModelScreen
    extends GetView<ChatSearchWithCsvClaudeModelScreenServices> {
  const ChatSearchWithCsvClaudeModelScreen({super.key});
              ...
              onSendTap: () {
                ...
                if(!controller.isSimpleChatApiLoading.value) {
                  controller.apiGetChatData(sentMessages: message,
                      apiUrlFromScreen: ApiEndpoints.searchWithCsvClaudeModel,
