...
import '../services/chat_search_with_csv_open_ai_model_screen_services.dart';

class ChatSearchWithCsvOpenAIModelScreen extends GetView<ChatSearchWithCsvOpenAIModelScreenServices> {
  const ChatSearchWithCsvOpenAIModelScreen({super.key});
  @override
              ...
              onSendTap: () {
                ...
                if(!controller.isSimpleChatApiLoading.value) {
                  controller.apiGetChatData(sentMessages: message,
                      ...
                      inputTextEditingController: controller.simpleChatTextController,
                    isFeedbackFormVisible: controller.showFeedbackResponseForm,
                    apiUrlFromScreen: ApiEndpoints.searchWithCsvOpenaiModel,);
                }
